...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class EditMessageController : ControllerBase
    {
        ...
        public async Task<ActionResult> EditMessageAsync(Guid id, EditMessageCommand command)
        {
            ...
            {
                _logger.Log(LogLevel.Warning, ex, "Could not retrieve aggregate, client passed an incorrect ID targetting the aggregate!");
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Error while processing request to edit the message of post!";
